...
<body>
    <div id="popup-add" class="hidden">
        <div id="popup-add-overlay" class="fixed inset-0 hidden items-center justify-center bg-black bg-opacity-50">
            <div id="popup-add-content" class="bg-white p-8 w-1/2 rounded-2xl">
                <h2 id="popup-add-form-title" class="font-extrabold mb-5">
                    Add New Barang
                </h2>
                <form id="popup-add-form"  action="/barang/add" method="POST" class="grid grid-cols-2 gap-5">
                    @csrf
                    <div class="col-span-1">
                        <label for="id_barang">ID Barang:</label>
                        <input type="text" id="id_barang_add" name="id_barang" class="w-full border border-gray-300 h-10 rounded p-1" required>
                    </div>
                    <div class="col-span-1">
                    ...
                    <div class="col-span-2 flex justify-center">
                        <button id="popup-add-form-button" type="submit" class="w-1/3 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-2xl">Add</button>
                    </div>
                </form>
            </div>
        </div>
