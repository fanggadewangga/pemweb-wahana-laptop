                ...
                <div class="rounded-3xl pb-8 bg-white">
                    ...
                    <div class="p-3 h-full w-full shadow-xl flex flex-row">
                        <div class="w-full flex justify-between p-4">
                            <h2 class="font-bold text-l text-purple-900 ml-6">Pembelian</h2>
                        </div>
                        ...
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex items-center justify-center">
                                <div class="items-center">
                                    <form action="/pembelian/search" method="GET"> <!-- Formulir pencarian dengan metode GET -->
                        ...
                        <tbody class="bg-white divide-y-2 divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-12 py-4 whitespace-nowrap text-base font-semibold text-gray-700 align-middle">
                                    {{ $pembelian->merk_barang }} {{ $pembelian->tipe_barang }}
                                </td>
                                <td class="px-12 py-4 whitespace-nowrap text-base font-semibold text-gray-700 align-middle">
                                    {{ $pembelian->jumlah_beli }}
                                </td>
                                <td class="px-12 py-4 whitespace-nowrap text-base font-semibold text-gray-700 align-middle">
                                    Rp {{ number_format($pembelian->harga_total, 0, ',', '.') }}
                                </td>
